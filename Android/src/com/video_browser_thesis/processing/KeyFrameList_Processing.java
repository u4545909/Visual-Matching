...
public class KeyFrameList_Processing implements Processing{
	...
	public KeyFrameList_Processing(String attach_url){
		base_url = "http://cantabile.anu.edu.au/memeapp/cgi-bin/mVideosJSONOutput.py?q=";
		url = base_url + attach_url;
		category_name = "matching_videos";
		setArrayContents();
	}
	...
	public Video_attributes[] getMatchingVideos(){
		return v_attr;
	}
}
