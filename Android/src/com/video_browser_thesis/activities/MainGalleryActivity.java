...
public class MainGalleryActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(isConnected(this)){
			...
			MarginLayoutParams mlp1 = (MarginLayoutParams) galleryView1.getLayoutParams();
			MarginLayoutParams mlp2 = (MarginLayoutParams) galleryView2.getLayoutParams();
			MarginLayoutParams mlp3 = (MarginLayoutParams) galleryView3.getLayoutParams();
			MarginLayoutParams mlp4 = (MarginLayoutParams) galleryView4.getLayoutParams();
			MarginLayoutParams mlp5 = (MarginLayoutParams) galleryView5.getLayoutParams();
	...
	/** Setting the margins for the Gallery */
	private void setMargins(MarginLayoutParams mlp){
		mlp.setMargins(-(metrics.widthPixels / 2 + 85), mlp.topMargin,
