...
public class CrossBrowserActivity extends Activity{
	...
	private CrossBrowser_ListAdapter cb_listAdapter;
	public static int k = 0;
	ListView crossbrowser_list;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		crossbrowser_list = (ListView) findViewById(R.id.cross_browser_listview);
		selected_img = (ImageView)findViewById(R.id.selected_matching_keyframe);
		...
		cb_listAdapter = new CrossBrowser_ListAdapter(this, defaultList);
		circularListAdapter = new CircularListAdapter(cb_listAdapter);
	...
	private class performBackgroundTask extends AsyncTask < Void, Void, Void>  
  {
     ...
     protected void onPreExecute(){ 
        super.onPreExecute();
             pdia = new ProgressDialog(CrossBrowserActivity.this);
...
//            super.onPostExecute(result);
    		cb_listAdapter = new CrossBrowser_ListAdapter(CrossBrowserActivity.this, keyframe_attr);
    		circularListAdapter = new CircularListAdapter(cb_listAdapter);
    		crossbrowser_list.setAdapter(circularListAdapter);
    		CB_GalleryProcessing cb_gall1;
    		int arr_len = 0;
