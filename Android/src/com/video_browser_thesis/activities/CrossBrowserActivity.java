...
public class CrossBrowserActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		MarginLayoutParams mlp1 = (MarginLayoutParams) crossbrowser_gallery.getLayoutParams();
		setMargins(mlp1);

		/** Retrieving processing information from URL*/
		CB_Processing cb_p = new CB_Processing(cb_bundle.getString("video_id"));
		final KeyFrame_attributes[] keyframe_attr = cb_p.getKeyFrameArray();
		...
		crossbrowser_list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position,
				...
				final KeyFrame_attributes[] keyframe_gall = cb_gall.getKeyFrameArray();			
	...
	/**
	 * Sets the margins of top, bottom, right and left sides of the galleryView
	 */
	private void setMargins(MarginLayoutParams mlp){
		mlp.setMargins((metrics.widthPixels / 2 - 365), mlp.topMargin+300,mlp.rightMargin, mlp.bottomMargin);
	}
